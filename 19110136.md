...
<img src="https://github.com/TranVanThien111/CSRF-Attack-Lab/blob/main/images/2.1.1.png?raw=true" alt="2.2.1" width="726">
...
<img src="https://github.com/TranVanThien111/CSRF-Attack-Lab/blob/main/images/2.1.1.png?raw=true" alt="2.2.2" width="726">

- Step 3: Integrate Referer and Origin checks into routes:

Call this check function on routes that need CSRF protection.
<img src="https://github.com/TranVanThien111/CSRF-Attack-Lab/blob/main/images/2.1.1.png?raw=true" alt="2.2.3" width="726">

### Result: 
<img src="https://github.com/TranVanThien111/CSRF-Attack-Lab/blob/main/images/2.1.1.png?raw=true" alt="2.2.4" width="726">
